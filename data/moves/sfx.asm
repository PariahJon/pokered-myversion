...
;	db SFX_BATTLE_0B,          $00, $80 ; TRIPLE_KICK
;	db SFX_BATTLE_0B,          $00, $80 ; THIEF
;	db SFX_BATTLE_0B,          $00, $80 ; SPIDER_WEB
;	db SFX_BATTLE_0B,          $00, $80 ; MIND_READER
;	db SFX_BATTLE_0B,          $00, $80 ; NIGHTMARE
;	db SFX_BATTLE_0B,          $00, $80 ; FLAME_WHEEL
;	db SFX_BATTLE_0B,          $00, $80 ; SNORE
;	db SFX_BATTLE_0B,          $00, $80 ; CURSE
;	db SFX_BATTLE_0B,          $00, $80 ; FLAIL
;	db SFX_BATTLE_0B,          $00, $80 ; CONVERSION_2
;	db SFX_BATTLE_0B,          $00, $80 ; AEROBLAST
;	db SFX_BATTLE_0B,          $00, $80 ; COTTON_SPORE
;	db SFX_BATTLE_0B,          $00, $80 ; REVERSAL
;	db SFX_BATTLE_0B,          $00, $80 ; SPITE
;	db SFX_BATTLE_0B,          $00, $80 ; POWDER_SNOW
;	db SFX_BATTLE_0B,          $00, $80 ; PROTECT
;	db SFX_BATTLE_0B,          $00, $80 ; MACH_PUNCH
;	db SFX_BATTLE_0B,          $00, $80 ; SCARY_FACE
;	db SFX_BATTLE_0B,          $00, $80 ; FEINT_ATTACK
;	db SFX_BATTLE_0B,          $00, $80 ; SWEET_KISS
;	db SFX_BATTLE_0B,          $00, $80 ; BELLY_DRUM
;	db SFX_BATTLE_0B,          $00, $80 ; SLUDGE_BOMB
;	db SFX_BATTLE_0B,          $00, $80 ; MUD_SLAP
;	db SFX_BATTLE_0B,          $00, $80 ; OCTAZOOKA
;	db SFX_BATTLE_0B,          $00, $80 ; SPIKES
;	db SFX_BATTLE_0B,          $00, $80 ; ZAP_CANNON
;	db SFX_BATTLE_0B,          $00, $80 ; FORESIGHT
;	db SFX_BATTLE_0B,          $00, $80 ; DESTINY_BOND
;	db SFX_BATTLE_0B,          $00, $80 ; PERISH_SONG
;	db SFX_BATTLE_0B,          $00, $80 ; ICY_WIND
;	db SFX_BATTLE_0B,          $00, $80 ; DETECT
;	db SFX_BATTLE_0B,          $00, $80 ; BONE_RUSH
;	db SFX_BATTLE_0B,          $00, $80 ; LOCK_ON
;	db SFX_BATTLE_0B,          $00, $80 ; OUTRAGE
;	db SFX_BATTLE_0B,          $00, $80 ; SANDSTORM
;	db SFX_BATTLE_0B,          $00, $80 ; GIGA_DRAIN
;	db SFX_BATTLE_0B,          $00, $80 ; ENDURE
;	db SFX_BATTLE_0B,          $00, $80 ; CHARM
;	db SFX_BATTLE_0B,          $00, $80 ; ROLLOUT
;	db SFX_BATTLE_0B,          $00, $80 ; FALSE_SWIPE
;	db SFX_BATTLE_0B,          $00, $80 ; SWAGGER
;	db SFX_BATTLE_0B,          $00, $80 ; MILK_DRINK
;	db SFX_BATTLE_0B,          $00, $80 ; SPARK
;	db SFX_BATTLE_0B,          $00, $80 ; FURY_CUTTER
;	db SFX_BATTLE_0B,          $00, $80 ; STEEL_WING
;	db SFX_BATTLE_0B,          $00, $80 ; MEAN_LOOK
;	db SFX_BATTLE_0B,          $00, $80 ; ATTRACT
;	db SFX_BATTLE_0B,          $00, $80 ; SLEEP_TALK
;	db SFX_BATTLE_0B,          $00, $80 ; HEAL_BELL
;	db SFX_BATTLE_0B,          $00, $80 ; RETURN_MOVE
;	db SFX_BATTLE_0B,          $00, $80 ; PRESENT
;	db SFX_BATTLE_0B,          $00, $80 ; FRUSTRATION
;	db SFX_BATTLE_0B,          $00, $80 ; SAFEGUARD
;	db SFX_BATTLE_0B,          $00, $80 ; PAIN_SPLIT
;	db SFX_BATTLE_0B,          $00, $80 ; SACRED_FIRE
;	db SFX_BATTLE_0B,          $00, $80 ; MAGNITUDE
;	db SFX_BATTLE_0B,          $00, $80 ; DYNAMIC_PUNCH
;	db SFX_BATTLE_0B,          $00, $80 ; MEGAHORN
;	db SFX_BATTLE_0B,          $00, $80 ; DRAGON_BREATH
;	db SFX_BATTLE_0B,          $00, $80 ; BATON_PASS
;	db SFX_BATTLE_0B,          $00, $80 ; ENCORE
;	db SFX_BATTLE_0B,          $00, $80 ; PURSUIT
;	db SFX_BATTLE_0B,          $00, $80 ; RAPID_SPIN
;	db SFX_BATTLE_0B,          $00, $80 ; SWEET_SCENT
;	db SFX_BATTLE_0B,          $00, $80 ; IRON_TAIL
;	db SFX_BATTLE_0B,          $00, $80 ; METAL_CLAW
;	db SFX_BATTLE_0B,          $00, $80 ; VITAL_THROW
;	db SFX_BATTLE_0B,          $00, $80 ; MORNING_SUN
;	db SFX_BATTLE_0B,          $00, $80 ; SYNTHESIS
;	db SFX_BATTLE_0B,          $00, $80 ; MOONLIGHT
;	db SFX_BATTLE_0B,          $00, $80 ; HIDDEN_POWER
;	db SFX_BATTLE_0B,          $00, $80 ; CROSS_CHOP
...
;	db SFX_BATTLE_0B,          $00, $80 ; MIRROR_COAT
;	db SFX_BATTLE_0B,          $00, $80 ; PSYCH_UP
;	db SFX_BATTLE_0B,          $00, $80 ; EXTREME_SPEED
;	db SFX_BATTLE_0B,          $00, $80 ; ANCIENTPOWER
;	db SFX_BATTLE_0B,          $00, $80 ; SHADOW_BALL
;	db SFX_BATTLE_0B,          $00, $80 ; FUTURE_SIGHT
;	db SFX_BATTLE_0B,          $00, $80 ; ROCK_SMASH
;	db SFX_BATTLE_0B,          $00, $80 ; WHIRLPOOL
;	db SFX_BATTLE_0B,          $00, $80 ; BEAT_UP	
